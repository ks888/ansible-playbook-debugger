...
### Table of Contents
* [Replace the entire arguments of a module](#example1)
* [Update one key=value argument of a module](#example2)
* [Check variables and facts](#example3)
* [Set breakpoints](#example4)
* [Check magic variables (hostvars, groups, etc.)](#example5)

<a name="example1"/>
## Replace the entire arguments of a module

In this example, an argument to ping module is invalid, and the entire arguments are replaced with new one.
...
<a name="example2"/>
## Update one key=value argument of a module
